  ...
  hotels: [
    {
      ...
      rows: [
        ...
        { label: '🅿️ 駐車場', val: 'ホテル併設 予約済み1600円／22時-6時は入出庫不可' },
        { label: '📋 プラン', val: '素泊まり' }
      ]
    },
    {
      ...
      rows: [
        ...
        { label: '🕒 CI', val: '15:00〜' },
        { label: '🕛 CO', val: '〜12:00' },
        { label: '🅿️ 駐車場', val: 'ホテル地下（先着順・2000円）' },
        { label: '📋 プラン', val: '素泊まり' }
      ]
    }
  ],
